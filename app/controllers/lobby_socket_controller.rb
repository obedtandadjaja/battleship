...
before_filter :check_authentication
	...
	def breakdown
		...
		# Problem here is that we are planning on storing completed games, so you have to find the non-completed game
		# instead of just the first entry. Otherwise, we will accidentally destroy all previous games in which this
